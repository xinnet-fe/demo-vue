  ...
  <div class="order-form">
    ...
    >
      <el-form v-if="dialogEditShow" ref="formEdit" :model="form2" :rules="rules" label-width="120px">
        <el-form-item label="销售负责人1:" prop="people">
          <el-select
            v-model="form2.people"
            placeholder="请选择"
            clearable
          >
            <el-option
        ...
        <el-form-item label="订单方式:" prop="type">
          <el-select
            v-model="form2.type"
            placeholder="请选择"
            clearable
        ...
        <el-form-item label="销售负责人2:" prop="people2">
          <el-select
            v-model="form2.people2"
            placeholder="请选择"
            clearable
          >
            <el-option
        ...
        <el-form-item label="成单类型:" prop="type2">
          <el-select
            v-model="form2.type2"
            placeholder="请选择"
            clearable
...
export default {
  ...
  data() {
    return {
      ...
      dialogEditShow: true,
      rules: {
        people: [{ required: true, message: '请选择', trigger: 'change' }],
        type: [{ required: true, message: '请选择', trigger: 'change' }],
        people2: [{ required: true, message: '请选择', trigger: 'change' }],
        type2: [{ required: true, message: '请选择', trigger: 'change' }]
      },
      businessType: [
        { label: '全部', value: '' },
        { label: '新开', value: 'N' },

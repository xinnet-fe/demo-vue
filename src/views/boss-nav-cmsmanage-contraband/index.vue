<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      标题： <el-input v-model="listQuery.title" placeholder="请输入标题" style="width: 200px;margin-right: 20px;" class="filter-item" @keyup.enter.native="handleFilter" />
      ...
      <el-button v-waves class="filter-item" type="primary" style="margin-right: 20px;">
        <a href="/#/boss-nav-cmsmanage-neaws">检索</a>
      </el-button>
      <el-button v-waves class="filter-item" type="primary" style="margin-right: 20px;" @click="handleJian">
        检索
      </el-button>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
        <el-form-item label="违禁词名称" prop="title">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        title: [{ required: true, message: '请输入违禁词名称', trigger: 'blur' }]
      },
  ...
  methods: {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['id', 'title', 'timestamp']
        const filterVal = ['id', 'title', 'timestamp']
    ...
    handleJian() {
      window.location.href = 'http://localhost:9527/#/boss-nav-cmsmanage/boss-nav-cmsmanage-knowledges/boss-nav-cmsmanage-news'
      console.log('12')
    },
    destroyOrder() {

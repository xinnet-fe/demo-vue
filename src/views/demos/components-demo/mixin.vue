...
<script>
import PanThumb from '@/components/demos/PanThumb'
import MdInput from '@/components/demos/MDinput'
import Mallki from '@/components/demos/TextHoverEffect/Mallki'
import DropdownMenu from '@/components/demos/Share/DropdownMenu'
import waves from '@/directive/demos/waves/index.js' // 水波纹指令

<template>
  <div class="agent-client-container">
    <el-form ref="searchForm" :model="searchForm" :inline="true">
      ...
      <el-form-item label="" prop="name">
        <el-input v-model="listQuery.title" placeholder="请输入关键词" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
      </el-form-item>
      <el-form-item label="注册时间" prop="state">
      ...
      <el-form-item>
        ...
        <el-button type="default" @click="resetModal('searchForm')">绑定客户</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :key="tableKey"
    ...
    >
      ...
      <el-table-column label="实名信息" width="150px" align="center">
        <template slot-scope="{row}">
...
<script>
import { fetchList, fetchPv, createArticle, updateArticle } from '@/api/demos/article'

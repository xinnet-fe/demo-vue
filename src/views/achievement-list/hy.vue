<template>
  <div class="order-form">
    ...
    >
      ...
      <el-table-column label="支付成功时间" prop="operateTime" width="150" show-overflow-tooltip />
      ...
      <el-table-column label="交易类型" prop="tradeType" width="80" show-overflow-tooltip />
      <el-table-column label="年限" prop="timeAmount" width="50" show-overflow-tooltip />
      ...
      <el-table-column label="成单类型" width="80" show-overflow-tooltip>
        <template slot-scope="{ row }">

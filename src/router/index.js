    ...
    children: [
      {
        ...
        meta: { title: '定向促销(旧)', affix: true }
      },
      {
        name: 'Marketchild1',
        path: 'rule',
        component: () => import('@/views/market/rule'),
        meta: { title: '活动规则设置', affix: true }
      },
      {
        name: 'Marketchild2',
        path: 'level',
        component: () => import('@/views/market/level'),
        meta: { title: '等级关联活动', affix: true }
      },
      {
        name: 'Marketchild3',
        path: 'commodity',
        component: () => import('@/views/market/commodity'),
        meta: { title: '商品关联活动', affix: true }
      }
    ]
  },
  ...demosConstantRoutes,
